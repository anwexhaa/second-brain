...
from services.pinecone_services import upload_pdf_vectors  # ✅ use new function
...
async def upload_pdf(file: UploadFile = File(...)):
    try:
        ...
        # ✅ Use new upload function; old vectors are automatically deleted
        upload_pdf_vectors(vectors)
